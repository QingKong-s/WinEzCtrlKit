...
constexpr inline D2D1_COLOR_F Palette_StdDark[]
{
    ...
    // Button
    StMakeBackgroundColorDark(0.45f),	// ButtonNormalBk
    StMakeForegroundColorDark(0.2f),	// ButtonNormalBorder
    ...
    // Header
    StMakeBackgroundColorDark(0.45f),	// HeaderNormalBk
    StMakeForegroundColorDark(0.55f),	// HeaderHotBk
    StMakeForegroundColorDark(0.6f),	// HeaderSelectedBk
};
