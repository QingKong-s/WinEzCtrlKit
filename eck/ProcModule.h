...
inline LDR_DATA_TABLE_ENTRY* FindModuleEntry(void* pBase,
	std::wstring_view svModuleName = {}, std::wstring_view svModulePath = {})
{
...
inline BOOL GetModuleFile(void* pBase, eck::CRefStrW& rsFileName)
{
	CLoaderLockGuard _{};
