...
protected:
    struct ITEM :public ITEMBASE
    {
        ...
        constexpr ITEM(ILayout* pCtrl, const MARGINS& Margin,
            UINT uFlags, short cx, short cy, UINT uWeight) noexcept
...
public:
    ...
    EckInlineCe void SetScaleMode(BOOL bScaleMode) noexcept { m_bScaleMode = bScaleMode; }
    EckInlineNdCe BOOL GetScaleMode() const noexcept { return m_bScaleMode; }
...
public:
    ...
    void Add(ILayout* pCtrl, const MARGINS& Margin = {},
