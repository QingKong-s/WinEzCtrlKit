...
struct CCompositor : public CRefObj<CCompositor>
{
    ...
    virtual void PtNormalToComposited(CElem* pElem, _Inout_ POINT& pt) noexcept {}
    ...
    /// <param name="pElem">目标元素</param>
    /// <param name="pt">坐标，相对pElem</param>
    virtual void PtCompositedToNormal(CElem* pElem, _Inout_ POINT& pt) noexcept {}
    ...
    virtual void CalcCompositedRect(CElem* pElem,
...
/*
    ...
    {}
    void CalcCompositedRect(CElem* pElem, _Out_ RECT& rc, BOOL bInClientOrParent) noexcept override
    {}
