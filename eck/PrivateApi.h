...
enum WINDOWCOMPOSITIONATTRIB
{
	...
	WCA_CORNER_STYLE = WCA_MINIMIZE_ANIMATION,			// Compatibility for SystemInformer
	WCA_PART_COLOR = WCA_MAXIMIZE_ANIMATION,			// Compatibility for SystemInformer
	WCA_SYSTEMBACKDROP_TYPE = WCA_SYSTEM_BACKDROP_TYPE,	// Compatibility for SystemInformer
};
/*
[?]DWMWA_FLIP3D_POLICY
Win7之外系统不处理此值
